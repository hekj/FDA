...
def parse_args():
    ...
    parser.add_argument("--features_fda", type=str, default='places365')
...
def postprocess_args(args):
    ...
    # Setup input paths
    ft_file_map = {
        'vitbase_r2rfte2e_rgb': 'vitbase_r2rfte2e_rgb.hdf5',
        'vitbase_r2rfte2e_fda': 'vitbase_r2rfte2e_fda.hdf5'
    }
    args.img_ft_file = os.path.join(ROOTDIR, 'R2R', 'features', ft_file_map[args.features])
    args.img_ft_file_fda = os.path.join(ROOTDIR, 'R2R', 'features', ft_file_map[args.features_fda])
