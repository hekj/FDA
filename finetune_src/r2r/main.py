...
def build_dataset(args, rank=0, is_test=False):
    ...
    feat_db = ImageFeaturesDB(args.img_ft_file, args.img_ft_file_fda, args.image_feat_size)
    ...
    if args.test or args.dataset != 'r4r' or (args.dataset == 'r4r' and args.r4r_testall):
        print("buiding the val_unseen split for validation")
...
def train(args, train_env, val_envs, aug_env=None, rank=-1):
    ...
    # resume file
    start_iter = 0
    # args.resume_file = '../datasets/R2R/trained_models/r2r-rgb-mask3-samestylediffcontent//ckpts/best_val_unseen'
