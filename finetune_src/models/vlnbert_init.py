...
def get_tokenizer(args):
    ...
    if args.dataset == 'rxr' or args.tokenizer == 'xlm':
        ...
        tokenizer = AutoTokenizer.from_pretrained('/path_to_tokenizer/bert-base-uncased')  # path to tokenizer file
    return tokenizer
...
def get_vlnbert_models(args, config=None):
    ...
    if args.dataset == 'rxr' or args.tokenizer == 'xlm':
        cfg_name = 'xlm-roberta-based'
        vis_config = PretrainedConfig.from_pretrained(cfg_name)
    else:
        # vis_config = PretrainedConfig.from_pretrained('bert-base-uncased')
        vis_config = PretrainedConfig.from_pretrained('/data/keji/Datasets/bert/bert-base-uncased')
    ...
    # model_class: vilmodel_cmt.py -> NavCMT()
